...
<div class="presentacion-index">
    ...
    $gridColumn = [
        ...
        [
            'attribute' => 'Fecha_Inicio_Real',
            //'value' => 'date("d/m/Y h:i",$data->Fecha_Inicio_Real);'
            'value' => function($model){                 
                   return date("d/m/Y h:i a",$model->Fecha_Inicio_Real);                 
               },
        ],
        [
            'attribute' => 'Fecha_Final_Real',
            'value' => function($model){                 
                   return date("d/m/Y h:i a",$model->Fecha_Final_Real);                 
               },
            //'value' => 'date("d/m/Y h:i",$data->Fecha_Final_Real);'
        ],
        [
            'attribute' => 'Fecha_Final_Real',
            'header'=>'Tiempo de duracion (Minutos)',
            'value' => function($model){                 
                   return (($model->Fecha_Final_Real-$model->Fecha_Inicio_Real)/60);                 
               },
            //'value' => 'date("d/m/Y h:i",$data->Fecha_Final_Real);'
        ],
        //'Vinculo',
        ...
        [
            ...
            'buttons' => [
                ...
                'iniciar' => function ($url) {
                    return Html::a('<span class="glyphicon glyphicon-ok-circle"></span>', $url, ['title' => 'Iniciar']);
                },
                'finalizar' => function ($url) {
                    return Html::a('<span class="glyphicon glyphicon-remove-circle"></span>', $url, ['title' => 'Finalizar']);
                },
            ],
        ],
    ]; 
