...
use backend\models\TipoUserSearch;
...
class TipoUserController extends Controller
{
    ...
    {
        $searchModel = new TipoUserSearch();
    ...
    /**
     * 
     * Export TipoUser information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new TipoUser model by another data,
