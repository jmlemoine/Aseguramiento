...
/* @var $searchModel backend\models\UserSalaSearch */
...
$this->title = Yii::t('app', 'User Salas');
...
?>
<div class="user-sala-index">

    
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Añadir User Sala'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-user-sala-search-user_id']
            ],
        [
                'attribute' => 'sala_id',
                ...
                'filterInputOptions' => ['placeholder' => 'Sala', 'id' => 'grid-user-sala-search-sala_id']
            ],
        [
