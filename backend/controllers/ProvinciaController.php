...
class ProvinciaController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-congreso'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionView($id)
    {
        ...
        $providerCongreso = new \yii\data\ArrayDataProvider([
            'allModels' => $model->congresos,
        ]);
        return $this->render('view', [
            'model' => $this->findModel($id),
            'providerCongreso' => $providerCongreso,
        ]);
    }
    ...
    /**
     * 
     * Export Provincia information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Provincia model by another data,
    ...
    * @return mixed
    */
    public function actionAddCongreso()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Congreso');
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formCongreso', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
